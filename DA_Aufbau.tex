...
\includepdf[pages=1-4]{doc/pdfs/E_DiplArbeit_Seite_4_5.pdf}                 %Dokumentation(PDF) einfügen
...
%%\include{files/Beginn/Diplomantenvostellung}  
...
%% danksagung ==========================================%%
\include{files/Beginn/Danksagung}                             
%%======================================================%%
...
\include{files/Beginn/1_einleitung}                                     %Einführung(LaTeX File) einfügen

%Chapter 2 - (Grundlagen & Methoden)
\responsible{Thomas Potzmader, Tobias Geppl} 
\include{files/Thomas/Beginn/grundlagen}   
\include{files/Tobias/Beginn/grundlagen}  %Grundlagen(LaTeX File) einfügen

%Chapter 3 - (Design & Konzept)
\responsible{Thomas Potzmader, Tobias Geppl} 
\include{files/Thomas/Beginn/design-konzept}   
\include{files/Tobias/Beginn/design-konzept}  %Methoden(LaTeX File) einfügen

%Chapter 4 Ergebnisse
\responsible{Thomas Potzmader, Tobias Geppl} 
\include{files/Beginn/4_ergebnisse}                                      %Ergebnisse(LaTeX File) einfügen


%Chapter 5 Hardwareentwicklung
\responsible{Tobias Geppl} 
\include{files/Tobias/Hardwareentwicklung}                                      

%Chapter 6 Mikrocontroller-Programmierung
\responsible{Tobias Geppl} 
\include{files/Tobias/uC-Programmierung}                                      

%Chapter 7 Datenbank
\responsible{Thomas Potzmader} 
\include{files/Thomas/Datenbank}

%Chapter 8 Website
\responsible{Thomas Potzmader} 
\include{files/Thomas/Website}     

%Chapter 9 Gehäuse
\responsible{Thomas Potzmader} 
\include{files/Thomas/Gehaeuse}   
...
%=============================%%
%
\include{files/Anhang/literatur}                                       %Literaturverzeichnis(LaTeX File) einfügen
...
\includepdf[pages=1]{doc/pdfs/Betreuungsprotokolle/DA-Betreuungsprotokoll-13.11.2024.pdf}          %Besprechunsprotokoll(PDF) einfügen
